...
namespace HBIS.ADD.Entities
{
    ...
    [ConnectionKey("Default"), Module("ADD"), TableName("[cad].[Exame]")]
    ...
    public sealed class ExameRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Paciente"), NotNull, ForeignKey("[cad].[Paciente]", "IdPaciente"), LeftJoin("jIdPaciente"), TextualField("IdPacienteContatoEmergencia")]
        ...
        [DisplayName("Médico Solicitante"), Column("CRM"), Size(50), NotNull, ForeignKey("[cad].[Medico]", "CRM"), LeftJoin("jCrm"), QuickSearch, TextualField("CrmCpf")]
        public String Crm
        {
        ...
        [DisplayName("Exame"), NotNull, ForeignKey("[cad].[ExameDescicao]", "IdExameDescricao"), LeftJoin("jIdExameDescricao"), TextualField("IdExameDescricaoDescricao")]
